        ...
        <div className="container mx-auto px-4 z-10">
          <div className="text-center max-w-5xl mx-auto">
            <div className="mb-8 inline-block">
              <div className="glass px-6 py-2 rounded-full text-sm font-medium">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <button className="group relative px-8 py-4 rounded-lg font-semibold text-lg overflow-hidden transition-all duration-300 hover:scale-105">
              ...
              <button className="glass glass-hover px-8 py-4 rounded-lg font-semibold text-lg">
                Tanıtım Videosu
              </button>
            </div>
          </div>
              ...
              <div className="relative z-10">
                <div className="grid md:grid-cols-2 gap-8 mb-12">
                  <div className="text-center md:text-left">
                    <p className="text-sm text-gray-400 mb-2">{t('proof.totalValue')}</p>
                    <p className="text-5xl md:text-7xl font-bold gradient-accent">₺0</p>
                  </div>
                  <div className="text-center md:text-right">
                    <p className="text-sm text-gray-400 mb-2">{t('proof.campaigns')}</p>
                    <p className="text-5xl md:text-7xl font-bold gradient-accent">1</p>
                  </div>
                </div>
                
                <div className="flex justify-center">
                  <a href="#" className="group inline-flex items-center gap-2 glass glass-hover px-6 py-3 rounded-lg font-semibold">
                    {t('proof.cta')}
                    <svg className="w-5 h-5 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8l4 4m0 0l-4 4m4-4H3" />
                    </svg>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="inline-block">
              <a href="/career" className="group relative inline-flex items-center gap-3 px-8 py-4 font-semibold text-lg">
